                           ...
                           <div class="row mt-3">
                              <div class="input-group mb-3">
                                 ...
                                 <div class="custom-file">
                                    <input type="file" onchange="resim_sayi_bas()" id="resim" class="custom-file-input" name="resim[]" multiple>
                                    <label class="custom-file-label" id="custom_file_input_sayisi">Eklemek İstediğiniz Yeni Resimleri Seçin</label>
                                 </div>
                              </div>
                              </div>
                              <div class="row">
...
<script>
                           function resim_sayi_bas(){
                              var resim_input=$('#resim')[0].files;
                              $('#custom_file_input_sayisi').html(resim_input.length+" ADET RESİM SEÇİLDİ")
                           }
                        </script>
   </body>
</html>