...
.drop-field,.drop-area,.drop-field .browse {
transition: all 0.3s;
}
            ...
            <div class="col-sm-8">
               ...
               <form method="POST" name="form" id="form" enctype="multipart/form-data">
                  ...
                  <div class="container mb-5">
                     <div class="row">
                        <div class="col">
                           <div class="form-group">
                              ...
                              <input type="text" name="plaka" id="plaka" value="<?=$plaka?>" class="form-control" style="text-transform: uppercase;" placeholder="01AA0000" onkeypress="return boslukEngelle()" pattern="[0-9]{2}[A-Za-z]{1,3}[0-9]{2,4}" oninvalid="this.setCustomValidity('LÜTFEN PLAKAYI DÜZGÜN GİRİN')" oninput="this.setCustomValidity('')" maxlength="8" required readonly/>  
                           </div>
                           <div class="form-group">
                              <label for="IDofInput">Aracın Şuanki Durumu</label>
                              <select class="form-control" name="arac_durumu" id="arac_durumu" disabled>
                                 <option value="1" <?php if($durum==1){echo "selected";} ?>>Kazalı (En Ufak Bir Onarım Görmemiş)</option>
                                 <option value="2" <?php if($durum==2){echo "selected";} ?>>Kazalı (Hafif onarımlar yapılmış halk ağzıyla makyajlı)</option>
                                 <option value="3" <?php if($durum==3){echo "selected";} ?>>İkinci El (Pert Kayıtlı)</option>
                                 <option value="4" <?php if($durum==4){echo "selected";} ?>> İkinci El (Pert Kayıtsız)</option>
                              </select>
                           </div>
                           <div class="form-group">
                              <label for="IDofInput">Şehir</label>
                              <select class="form-control" name="sehir" id="sehir" required>
                           ...
                           <div class="form-group">
                              ...
                              <select class="form-control" name="ilce" id="ilce" disabled required>
                                 <option value="">İlçe seçin</option>
                              </select>
                           </div>
                           <div class="form-group">
                              <label for="IDofInput">Yakıt Tipi</label>
                              <select class="form-control" name="yakit_tipi" id="yakit_tipi" required>
                           ...
                           <div class="form-group">
                              ...
                              <select class="form-control" name="vites_tipi" id="vites_tipi" required>
                                 <option value="">Seçiniz</option>
                           ...
                           <div class="form-group">
                              ...
                              <select class="form-control" name="evrak_tipi" id="evrak_tipi" required>
                                 <option value="">Seçiniz..</option>
                                 <option value="Plakalı Ruhsatlı">Plakalı Ruhsatlı</option>
                        ...
                        <div class="col">
                           <div class="form-group">
                              ...
                              <input type="checkbox" name="hasar[]" value="1">Çarpma, Çarpışma<br>
                              <input type="checkbox" name="hasar[]" value="2">Teknik Arıza<br>
                              <input type="checkbox" name="hasar[]" value="3">Sel/Su Hasarı<br>
                              <input type="checkbox" name="hasar[]" value="4">Yanma Hasarı<br>
                              <input type="checkbox" name="hasar[]" value="5">Çalınma<br>
                              <input type="checkbox" name="hasar[]" value="6">Diğer<br>
                           ...
                           <div class="form-group">
                              ...
                              <select class="form-control" name="marka" id="marka" required>
                                 <option value="">Seçiniz..</option>
                                 <?php $marka_cek = mysql_query("SELECT * FROM marka order by marka_adi asc"); while($marka_oku = mysql_fetch_array($marka_cek)){ ?>
                           ...
                           <div class="form-group">
                              ...
                              <input type="number" class="form-control" name="model_yili" required maxLength="4" min="1950" max="<?= $anlik_yil; ?>">
                           </div>
                           <div class="form-group">
                              <label for="IDofInput">Model Uzantıları</label>                    
                              <input type="text" class="form-control" name="uzanti" id="uzanti"  style="text-transform:uppercase"  placeholder="1.6 DCI Expression vb.">
                              <small class="form-text text-muted">Paket Silindir Hacmi bilgileri yazınız</small>
                           </div>
                           <div class="form-group">
                              <label for="IDofInput">Kilometre (KM)</label>
                              <input class="form-control" type="number" name="kilometre">
                           </div>
                           <div class="form-group">
                              <label for="IDofInput">Satış Fiyat (₺)</label>
                              <input class="form-control" type="number" required name="satis_fiyati">
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="form-group" style="width:100% !important;">
                           ...
                           <textarea name="aracin_adresi" id="aracin_adresi" required class="form-control" rows="4"></textarea>
                        </div>
                        <div class="form-group" style="width:100% !important;">
                           <label for="IDofInput">Açıklamalar (Lütfen alıcılar için gerekli her şeyi anlatınız.)</label>
                           <textarea name="aciklamalar" id="aciklamalar" class="form-control" rows="8" ></textarea>
                        </div>
                        <!-- <div class="input-group mb-3">
                           ...
                           <div class="custom-file">
                              ...
                              <label class="custom-file-label" for="inputGroupFile01">Resimleri Seçin</label>
                           </div>
                        </div> -->
                        <!-- <div class="form-group">
                              <br/>
                     ...
                     <div class="row">
                        <input type="submit" class="btn btn-primary" name="dogrudan_satisi" value="Kaydet">
                     </div>
                  </div>
               </form>
               <?php } ?>
