  ...
  margin:0px!important;
    ...
    <div class="container" style="margin-top:2%; margin-bottom:5%;">
      <div class="row">
        ...
        <?php 
        // $odeme_bekleyen_cek = mysql_query("SELECT * FROM kazanilan_ilanlar WHERE durum = 2 AND uye_id = '".$kullanici_oku['id']."'");	
        $odeme_bekleyen_cek = mysql_query("SELECT * FROM kazanilan_ilanlar LEFT JOIN ilanlar ON kazanilan_ilanlar.ilan_id = ilanlar.id 
        WHERE kazanilan_ilanlar.uye_id = '".$kullanici_oku['id']."' AND ilanlar.id = kazanilan_ilanlar.ilan_id AND kazanilan_ilanlar.durum = 2");
                          ...
                          <table class="table table-bordered">
                            <tbody>
                              ...
                              <tr style="background-color: transparent;">
                                ...
                                <td><span class="statu_baslik">Statü:</span> Son İşlemde</td>
