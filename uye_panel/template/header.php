        ...
        <div class="row align-items-center position-relative">
            ...
            <div class="col-10 text-right" style="margin-top:1%;">
                <nav class="site-navigation text-right ml-auto d-none d-lg-block"
                    style="margin-bottom:-4% !important; margin-top:-3% !important;" role="navigation">
                    <ul class="site-menu main-menu js-clone-nav ml-auto profile_menu_btn">
                        ...
                        <li style="font-size:14px;">
                            ...
                            <a href="#exampleModal2" data-toggle="modal" class="nav-link"><i style="color: gold;"
                              class="fas fa-user"> Giris Yap</i> </a>
                        ...
                        <li style="font-size:14px;">
                            <?php if(!isset($_SESSION['u_token'])||!isset($_SESSION['k_token'])){ ?>
                            <a href="#exampleModal" data-toggle="modal" class="nav-link"><i style="color: gold;"
                                    class="fas fa-sign-in-alt"> </i> Uye Ol </a>
                            <?php }else{ ?>
        ...
        <div class="row align-items-center position-relative">
            ...
            <div class="col-xs-4 col-sm-9 text-right mobile_menu_dis">
                <span class="d-inline-block d-lg-none">
                    <a href="#" class="text-white site-menu-toggle js-menu-toggle py-5 text-white">
                        <span class="icon-menu h3 text-white"></span></a></span>
                <nav class="site-navigation text-right ml-auto d-none d-lg-block" style="font-size: 14px;"
                    role="navigation">
                    <ul class="site-menu main-menu js-clone-nav ml-auto ">
                        ...
                        <li style="font-size: 12px; padding:0px;" class="nav-link px-1"><a href="../sistem_nasil_isler.php">Sistem Nasıl
                                İşler?</a></li>
                        <li style="font-size: 12px; padding:0px;" class="nav-link px-1"><a
                                href="../yorumlar.php">Yorumlar</a></li>
                        <li style="font-size: 12px; padding:0px;" class="nav-link px-1"><a
                                href="../contact.php">İletişim</a></li>
                        <li style="font-size: 13px;" class="nav-link yeni px-1"><a
                                href="../ihaledeki_araclar.php"><i class="fas fa-gavel"></i> İHALEDEKİ ARAÇLAR<sup><?= $ihale_sayisi2 ?></sup></a></li>
                        <li style="font-size: 13px;" class="nav-link yeni px-1"><a
                                href="../dogrudan_satisli_araclar.php"><i class="fas fa-handshake"></i> DOĞRUDAN
