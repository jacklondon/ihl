  ...
  <ul class="navbar-nav mr-auto" >
      ...
      <div class="container" style="margin-top:10%;">
         ...
         <?php include 'template/sidebar.php'; ?>
            ...
            <div class="col-sm-8">
            <form method="POST">
            <?php include 'islemler/cayma_duzenle.php' ;?>
               <div class="form-group">
                  <label for="exampleInputEmail1">IBAN</label>
                  
                  <?php $cayma_oku = mysql_fetch_assoc($cayma_cek2);
                     $uyenin_id = $cayma_oku['uye_id'];
                                   
                  ?>
                  <input type="text" name="iban" class="form-control" value="<?= $cayma_oku['iban'] ?>" onkeypress="return isNumberKey(event); return boslukEngelle();" maxLength="24" minlength="24" placeholder="Başında TR olmadan sadece rakam girebilirsiniz.">
                  <?php  ?>
               </div>
               <input type="submit" class="btn btn-primary" name="cayma_bedelini" value="Kaydet">
            </form>
            </div>
         </div>
      </div>
