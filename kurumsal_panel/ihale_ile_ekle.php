         ...
         <div class="row">
            ...
            <div class="col-sm-8">
               ...
               <form method="POST" name="form" id="form" enctype="multipart/form-data">
                  <?php include 'islemler/ihale_ekle.php'; ?>
                  <div class="container mb-5">
                     <div class="row">
                        <div class="col">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="uzanti"   style="text-transform:uppercase"  id="uzanti" placeholder="1.6 DCI Expression vb.">
                           ...
                           <div class="form-group">
                              ...
                              <input type="number" class="form-control" name="model_yili" maxLength="4" min="1950" max="<?= $anlik_yil; ?>" required>
                           </div>
                           <div class="form-group">
                              <label for="IDofInput">Aracı Satacağınız En Düşük Fiyat (₺)</label>
                              <input class="form-control" type="number" name="satis_fiyati" required>
                           </div>
                        </div>
                        <div class="col">
                           <div class="form-group">
                          ...
                          <!--  <div class="form-group">
                              ...
                              <select class="form-control" name="ilce" id="ilce" disabled>
                           ...
                           <div class="form-group">
                              ...
                              <input class="form-control" type="number" name="kilometre" required>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="form-group" style="width:100% !important;">
                           ...
                           <textarea name="uyari_notu" id="uyari_notu" class="form-control"  rows="4"></textarea>
                        </div>
                        <div class="form-group" style="width:100% !important;">
                           <label for="IDofInput">Araç hangi adresten teslim ediiecek adres ve yetkili kişi tel bilgilerini giriniz.</label>
                           <textarea name="aracin_adresi" id="aracin_adresi" required class="form-control" rows="8" ></textarea>
                        </div>
                        <div class="form-group" style="width:100% !important;">
                           <label for="IDofInput">Hasar Bilgileri</label>
                           <textarea name="hasar_bilgileri" id="hasar_bilgileri" class="form-control" rows="8" ></textarea>
                        </div>
                        <div class="form-group" style="width:100% !important;">
                           <label for="IDofInput">Notlar</label>
                           <textarea name="notlar" id="notlar" class="form-control" rows="8" ></textarea>
                        </div>
                     ...
                     <div class="row">
                        <input type="submit" class="btn btn-primary" name="ihaleyi" value="Kaydet">
                     </div>
                  </div>
               </form>
               <?php } ?>
...
<script>
	...
	$(document).ready(function() {
      ...
      <script>
			...
			/*  CKEDITOR.replace( 'aracin_adresi', {
			height: 250,
			extraPlugins: 'colorbutton,colordialog',
			removeButtons: 'PasteFromWord'	
		} ); */
