	...
	<?php } ?>
      ...
      <?php  include 'template/header.php'; ?>
         ...
         <div class="row">
            <div class="col-sm-12">
				<form method="POST">
					<input type="hidden" name="q" value="<?=re("q") ?>" >
					<input type="hidden" name="d" value="<?=re("d") ?>" >
					...
					<?php
						...
						echo $ilan_uyari;
					?>
					<input type="submit" class="btn btn-success" value="Kabul Ediyorum" name="kabul">
					<input type="submit" class="btn btn-secondary" value="İptal" name="iptal">
				</form>
            </div>
         </div>
      </div>
	 ...
	 <?php
		...
		if(re("kabul")=="Kabul Ediyorum"){
			header("Location: ihale_ile_ekle.php?q=".re("q")."&d=".re("d")."");
		}
		if(re("iptal")=="İptal"){

			header("Location: yeni_ilan_ekle.php");
