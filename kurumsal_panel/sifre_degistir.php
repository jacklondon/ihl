         ...
         <div class="row">
            ...
            <div class="col-sm-8">
               <form method="POST" name="form" id="form" enctype="multipart/form-data">
                  <?php include('islemler/sifre_degistir.php'); ?>
                  <div class="form-group">
                     <label for="IDofInput">Mevcut Şifre</label>
                     <input type="password" name="sifre" class="form-control" id="exampleInputPassword1">
                  </div>
                  <div class="form-group">
                     <label for="IDofInput">Yeni Şifre</label>
                     <input type="password" name="yeni_sifre" class="form-control" id="exampleInputPassword1">
                  </div>
                  <div class="form-group">
                     <label for="IDofInput">Yeni Şifre Tekrar</label>
                     <input type="password" name="yeni_sifre_tekrar" class="form-control" id="exampleInputPassword1">
                  </div>
                  <input type="submit" class="btn btn-primary" name="sifre_degisikligini" value="Kaydet">
               </form>
            </div>
         </div>
      </div>
