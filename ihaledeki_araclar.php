...
<?php 
   ...
   $toplam_sayfa_sql = mysql_query("SELECT COUNT(*) FROM ilanlar WHERE ihale_son_gosterilme >= '".date("Y-m-d H:i:s")."'");
...
<html lang="tr">
               ...
               <?php $sira2++; } } } ?> -->
                        <?php 
                           ...
                           for($i=0;$i<count($son_gezdiklerim);$i++){
                              ...
                              $bitis_tarihi=$son_gezdiklerim[$i]["ihale_tarihi"]." ".$son_gezdiklerim[$i]["ihale_saati"];
                              ...
                              <div class="website_fullwidth_slider_box '.$class.'">
                                    ...
                                    <div class="website_fullwidth_slider_box_contents">
                                       ...
                                       <h4>'.$text_string.'</h4>
                                       <h5 class=" class="en_yuksek_'.$son_gezdiklerim[$i]["id"].'"" id="son_gezdigim_fiyat_'.$son_gezdiklerim[$i]["id"].'">'.$son_teklif.'</h5>
                                    </div>
                              </div>
                              </a>
                           </div>';
                           ...
                           $son_eklenen = son_eklenen_ilanlar(50);
                           $sira_array2=array();
                           $sira2 = 0;
                              ...
                              '.$a_tag.'
                                 <div class="website_fullwidth_slider_box '.$class.'">
                                    ...
                                    <div class="website_fullwidth_slider_box_contents">
                                       ...
                                       <h4>'.$text_string.'</h4>
                                       <h5 style="display: none;">'.$son_eklenen[$i]["son_teklif"].'₺</h5>
                                    ...
                                    if($uye_token!=""){
                                    	...
                                    	while($row_teklif=mysql_fetch_object($sql_teklif)){
                                    		if($row_teklif->teklif == $filtre_oku['son_teklif'] ){
                                    			$en_yksk ='<b style="color: green; text-align:center;float:right;display: none">En yüksek teklif sizindir.</b><br/>
   ...
   <div class="modal-dialog">
      ...
      <div class="clearfix"></div>
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ihale_slider_outer">
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 website_fullwidth_slider_outer" style="margin-top:0px;">
            <div class="website_fullwidth_slider_title">
               <a href="son_eklenenler.php">Son Eklenen 200 Araç İçin Tıklayınız.</a>
            </div>
...
<script>
   ...
   $(document).ready(function(){
      ...
      document.getElementById("customSliderOuter").style.width = customSliderWidth+"px";
      setTimeout(function(){ 
         owl = $('.custom_mini_slider_boxes_contents').owlCarousel({
            margin:10,
            loop:true,
            items:2,
            autoplay:true,
