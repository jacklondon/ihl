<?php 
	...
	$say = mysql_num_rows(mysql_query("select * from kullanicilar where durum!='0' ".$kosul." ".$listeleme_kurali));
	...
	$sayi = 0;
	$kullanicilar = '';
	$kullanici_cek = mysql_query("select * from kullanicilar where durum!='0' ".$kosul." ".$listeleme_kurali." ".$limit.', '.$sayfada);
