<?php 
	...
	if(re('kullanici') != "")
	{
		...
		if($kullanici_oku4['durum']==1)
		{
			$durum_aktif = 'selected';
		}
		
		if($kullanici_oku4['durum']==2)
		{
			$durum_pasif = 'selected';
		}
	}
