var App = function () {
    ...
    var handleLoginForm = function () {
        ...
        /*$('.login-form').validate({
            ...
            messages: {
                username: {
                    required: "Kullanıcı adı girilmelidir."
                },
                password: {
    ...
    /*    $('.login-form input').keypress(function (e) {
        ...
        $('.register-form').validate({
            ...
            messages: { // custom messages for radio buttons and checkboxes
                tnc: {
                    required: "Sözleşmeyi okuyun ve onaylayın."
                }
            },
    ...
    var handleNestableList = function () {
        ...
        var updateOutput = function (e) {
            ...
            if (window.JSON) {
                ...
                output.val('Teknik birimle irtibata geçiniz..');
            }
        };
    ...
    var handleFormValidation = function () {
        ...
        form2.validate({
            ...
            messages: { // custom messages for radio buttons and checkboxes
                membership: {
                    required: "Bir üyelik türü seçiniz."
                },
                service: {
