   ...
   $today = date("Y-m-d");
    ...
    <div class="row-fluid">
       ...
       <label for="IDofInput">IBAN</label>
          <input type="number" readonly minLength="24" maxLength="24" name="aktif_iban" id="aktif_iban" value="'.$de["iban"].'" class="span12">
       </div>
       <div class="span6">
          <label for="IDofInput">Tutar</label>
          <input type="text" name="aktif_tutar" id="aktif_tutar" value="'.$de["net"].'" class="span12">
