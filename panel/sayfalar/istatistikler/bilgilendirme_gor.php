<form method="POST">
	<?php 
		...
		$bilgilendirme_sor=mysql_query("select * from bilgilendirme_mail where id='".re('mesaj')."'");
		$bilgilendirme_oku=mysql_fetch_assoc($bilgilendirme_sor);
	?>
	<!--<div class="span6">
	...
	<div class="span6">
		...
		<div class="well">
			<address>
				...
				<?php echo $bilgilendirme_oku['mail']; ?>
			</address>
			<address>
				<strong>Tarih</strong><br />
				<?php echo date('d.m.Y H:i:s',$bilgilendirme_oku['tarih']); ?>
			</address>
			<!--<address>
