...
<body>
    <section id="default-card" class="default-card">
        <div class="container card">
            <h1 class="title-main">PERT DÜNYASI</h1>
            <p class="subheading">SİTEMİZ BAKIM AŞAMASINDADIR</p>
            ...
            <p class="text">Çok Yakında Tekrar Hizmet Vereceğiz, Anlayışınız İçin Teşekkürler.</p>
        </div>
    </section>
