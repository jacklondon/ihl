    ...
    <div class="customSplashScreenOuter" style="background-image:url('images/sliders/f7470798a2c7389d43b6c8c52cc2c055.png');">
        <div class="customMobileLoginPageInner">
            ...
            <div class="customMobileLoginPageInputOuter">
                <p>E-Posta Adresi*</p>
                <input type="email" id="sifremi_unuttum_mail" placeholder="E-Posta Adresinizi Giriniz." />
            </div>
            <div class="customMobileLoginPageInputOuter">
                <p>GSM No*</p>
                <input type="tel" id="sifremi_unuttum_tel" placeholder="(---) --- -- --" maxlength="14" />
            </div>
            <button class="customMobileLoginBtn" onclick="mobileSifreSifirla()">
                Kod Gönder
            </button>
        </div>
    </div>
