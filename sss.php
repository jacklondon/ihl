	...
	<div class="accordion mb-3" id="accordionExample">
		<div class="card" style="display: none;">
			<div class="card-header" style="padding: 6px;">
				<button  class="btn btn-link" type="button" data-toggle="collapse" data-target="#arac_satin_alma" >
					Araç satın alma şartları nedir ?
				</button>
			</div>
			<div id="arac_satin_alma" class="collapse"  data-parent="#accordionExample">
				<div class="card-body">
					<?php 
						$sart_cek = mysql_query("SELECT * FROM arac_satin_alma_sartlari");
						$sart_oku = mysql_fetch_array($sart_cek);
						echo $sart_oku["sartlar"];
					?>
				</div>
			</div>
		</div>
		<?php
			while($soru_oku = mysql_fetch_array($soru_cek)){	 
				...
				<div class="card">
					<div class="card-header" style="padding: 6px;">
						<button  class="btn btn-link" type="button" data-toggle="collapse" data-target="#b<?=$soru_id ?>" >
							<?=$soru_oku["soru"]?>
						</button>
					</div>
					<div id="b<?= $soru_id ?>" class="collapse"  data-parent="#accordionExample">
						<div class="card-body">
							<?=$soru_oku["cevap"]?>
						</div>
					</div>
